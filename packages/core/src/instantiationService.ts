...
export class InstantiationService implements IInstantiationService {
  ...
  constructor(services: ServiceCollection = new ServiceCollection(), strict = false, parent?: InstantiationService) {
  ...
  private _createServiceInstanceWithOwner<T>(id: ServiceIdentifier<T>, ctor: any, args: any[] = [], supportsDelayedInstantiation: boolean, _trace: Trace): T | undefined {
    if (this._services.get(id) instanceof SyncDescriptor)
